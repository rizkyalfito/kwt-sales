                    ...
                    <div class="card-body">
                        <form action="<?= base_url('produk/simpan') ?>" method="post" enctype="multipart/form-data">
                            <div class="mb-2">
                                ...
                                <input type="text" class="form-control" id="produk" placeholder="Masukkan nama produk" name="produk" required>
                            </div>
                            <div class="mb-2">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" class="form-control" id="detail" placeholder="Masukkan detail produk" name="detail" required>
                            </div>
                            <div class="mb-4">
                                <label for="gambar" class="form-label">Gambar Produk</label>
                                <input type="file" class="form-control" id="gambar" placeholder="Masukkan detail produk" name="gambar" accept=".jpg,.png,.jpeg,.webp" required>
                            </div>
                            <div class="row mt-4">
                                <div class="col-12">
